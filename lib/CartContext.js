...
const CART_CONFIG = {
  // Local Storage
  storageKey: 'leatherloft-cart',
  
  // Default Values
  defaultBrand: 'LEATHER LOFT'
};
...
const buildConfiguration = (product, userSelections = {}) => {
  ...
  // Leather products typically don't have complex configurations
  // Keep the configuration simple for leather goods
