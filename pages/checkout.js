...
const CHECKOUT_CONFIG = {
  ...
  // SEO & Meta
  pageTitle: 'Checkout - Marakish',
  pageDescription: 'Complete your order for premium cleaning products',
  ...
  emptyCartMessage: 'Add some cleaning products to your cart before checking out.',
      ...
      <>
        ...
        <div className="min-h-screen bg-gray-50 flex items-center justify-center">
          <div className="text-center">
            ...
            <Link href={CHECKOUT_CONFIG.shopRoute} className="bg-gradient-to-r from-blue-500 to-green-500 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-600 hover:to-green-600 transition-all duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-200 h-fit">
              ...
              {/* Payment Method */}
              <div className="mt-6 p-4 bg-gradient-to-r from-blue-500 to-green-500 rounded-lg">
