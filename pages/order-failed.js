...
const ORDER_FAILED_CONFIG = {
  ...
  // SEO & Meta
  pageTitle: 'Order Failed - AlHafiz Milk and Sweets',
  pageDescription: 'Order processing failed',
  faviconPath: '/assets/alhafiz_logo.png',
  faviconSize: '32x32',

  // Contact Information
  supportEmail: 'info@alhafizsweetsandmilk.com',
  ...
  errorMessages: {
    ...
    inventory_unavailable: {
      ...
      description: 'One or more traditional sweets in your cart are currently out of stock.',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  className="w-full bg-red-500 hover:bg-red-600 text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                >
              ...
              <div className="text-center">
                <Link href={ORDER_FAILED_CONFIG.shopRoute} className="text-red-600 hover:text-red-700 font-medium">
            ...
            <div className="mt-8 bg-red-50 border border-red-200 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-red-800 mb-4">{ORDER_FAILED_CONFIG.helpTitle}</h3>
              <p className="text-sm text-red-700 mb-4">{ORDER_FAILED_CONFIG.helpDescription}</p>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Visit our{' '}
                <Link href={ORDER_FAILED_CONFIG.contactRoute} className="text-red-600 hover:text-red-700 font-medium">
                  Contact Page
                </Link>
