      ...
      case 'inventory_unavailable':
        return {
          ...
          suggestions: [
            ...
            'Choose alternative menu items',
            'Try ordering during different hours',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-2xl mx-auto">
            ...
            <div className="text-center mb-8">
              ...
              {retryCount > 0 && (
                <div className="bg-[#FFCC00] bg-opacity-20 border border-[#FFCC00] rounded-lg p-3 inline-block">
              ...
              <div className="space-y-3">
                {errorDetails.suggestions.map((suggestion, index) => (
                  <div key={index} className="flex items-start space-x-3">
                    <div className="w-6 h-6 bg-[#FF0000] bg-opacity-10 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                      <span className="text-xs font-bold text-[#FF0000]">{index + 1}</span>
                    </div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <button
                  ...
                  className="w-full bg-[#FF0000] hover:bg-[#CC0000] text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                >
                ...
                <button
                  ...
                  className="w-full bg-[#FFCC00] hover:bg-[#E6B800] text-black py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center"
                >
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="text-center">
                <Link href="/shop" className="text-[#FF0000] hover:text-[#CC0000] font-medium">
                  ← Back to Menu
                </Link>
              </div>
            </div>
            ...
            {/* Additional Help */}
            <div className="mt-8 bg-[#FF0000] bg-opacity-5 border border-[#FF0000] border-opacity-20 rounded-lg p-6">
              <h3 className="text-lg font-semibold text-[#FF0000] mb-4">Need More Help?</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">support@forkandknife.com</p>
                    <p className="text-xs text-gray-600">Response within 2 hours</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">Daily 10AM-11PM</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                Visit our{' '}
                <Link href="/contact" className="text-[#FF0000] hover:text-[#CC0000] font-medium">
                  Contact Page
                </Link>
